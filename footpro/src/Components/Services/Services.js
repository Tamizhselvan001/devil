...
<div class="container mt-4">
    ...
    <div class="row">
        <div class="col text-center mt-3">
            <img class="w-100 rounded" src={bg1} alt="Image"/>
            <h5>German Technology</h5>
        </div>
        <div class="col text-center mt-3">
            <img class="w-100 rounded" src={bg2} alt="Items"/>
            <h5>German Technology</h5>
        </div>
        <div class="col text-center mt-3">
            <img class="w-100 rounded" src={bg3} alt="Items"/>
            <h5>German Technology</h5>
        </div>
        <div class="w-100"></div>
        <div class="col text-center mt-3">
            <img class="w-100 rounded" src={bg4} alt="Items"/>
            <h5>German Technology</h5>
        </div>
        <div class="col text-center mt-3">
            <img class="w-100 rounded" src={bg5} alt="Items"/>
            <h5>German Technology</h5>
        </div>
        <div class="col text-center mt-3">
            <img class="w-100 rounded" src={bg6} alt="Items"/>
            <h5>German Technology</h5>
        </div>
    </div>
</div>
